...
function App() {
  ...
  return (
    <div className={`flex min-h-screen transition-colors duration-300 ${settings.darkMode ? "bg-[#121212]" : "bg-[#F8F9FB]"
      }`}>
      {!isLoginPage && <Sidebar />}

      <main
        className={`flex-1 transition-all duration-300 min-h-screen ${settings.darkMode ? "bg-[#121212]" : "bg-[#F8F9FB]"
          } ${isLoginPage
